            ...
            case 'M':
                ...
                switch (int_value) {
                    ...
                    case 7:
                        ...
                        gconf.gedm_single_axis_drill_task = !gconf.gedm_single_axis_drill_task;
                        break;
                    case 8:
                        gconf.gedm_wire_gcode_task        = false;
                        gconf.gedm_single_axis_drill_task = false;
                        gconf.gedm_floating_z_gcode_task  = !gconf.gedm_floating_z_gcode_task;
                        break;

                    case 9:
                        gconf.gedm_single_axis_drill_task = false;
                        gconf.gedm_floating_z_gcode_task  = false;
                        gconf.gedm_wire_gcode_task        = !gconf.gedm_wire_gcode_task;
                        break;
    ...
    */
    ...
    switch (gc_block.non_modal_command) {
        ...
        case NonModal::GoHome1:
            ...
            if (axis_command != AxisCommand::None) {
                glimits.limitsCheckSoft(gc_block.values.xyz);
                cartesian_to_motors(gc_block.values.xyz, pl_data, gc_state.position);
            }
            glimits.limitsCheckSoft(coord_data);
